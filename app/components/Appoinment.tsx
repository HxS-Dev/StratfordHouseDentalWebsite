     ...
     return (
          <section className='md:mx-5 mx-4 md:py-16 pt-10'>
               <div className='xl:max-w-[1230px] relative w-full max-w-[952px] bg-blue-1200 md:py-[90px] py-[34px] md:px-20 px-4 mx-auto'>
                    ...
                    <Link href='https://booking.uk.hsone.app/soe/new/%20?pid=UKELU03' className='md:text-base transition-all duration-300 hover:bg-blue-1400 text-sm bg-blue-1500 font-semibold leading-[150%] text-blue-1300 inline-block py-[14px] px-6'>Book Appointment Now </Link>
